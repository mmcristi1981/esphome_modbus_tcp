...
//class Modbus : public Component, public tcp::TCPDevice {
 // class Modbus : public Component  {
...
class ModbusDevice {
 public:
  ...
  bool waiting_for_response() { return parent_->waiting_for_response_ != 0; }
  ...
  //bool ready_for_immediate_send() { return parent_->waiting_for_response != 0; }
